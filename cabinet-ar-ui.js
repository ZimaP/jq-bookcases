...
} from "./cabinet-ar.js?v=full-system-20260714a";
import { generateProceduralCabinetModel } from "./cabinet-ar-model.js?v=full-system-20260714a";
import { iconSvg } from "./icon-system.js?v=full-system-20260714a";
...
export class CabinetArController {
  ...
  setLaunchButtonLoading(loading) {
    ...
    if (label) label.textContent = loading ? "Preparing Room View…" : "AR View in Your Room";
  }
