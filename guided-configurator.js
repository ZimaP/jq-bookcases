...
} from "./guided-configurator-state.js?v=mobile-detail-floor-v1";
import {
  getImmersiveLayout,
  millimetersToInches
...
function syncGuidedScene() {
  ...
  const importPromise = guidedSceneImportPromise ||= import("./guided-layout-viewer.js?v=paint-lighting-definition-v1");
  importPromise
