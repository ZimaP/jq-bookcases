...
export const iconManifest = Object.freeze({
  ...
  "hardware": defineIcon("Styles & finishes", "Hardware", "Cabinet knob and pull hardware", `<circle cx="6.5" cy="7.5" r="3"/><path d="M6.5 10.5v3M4.5 13.5h4M13 6.5h8v3h-8zM15 9.5v7M19 9.5v7M13.5 16.5h3M17.5 16.5h3"/>`),
  ...
  "paint-finish": defineIcon("Styles & finishes", "Paint finish", "Paint brush for material and color finishes", `<path d="M5 3h14v7H5zM7 3v4M11 3v4M15 3v4M7 10h10v4H7zM10 14h4v7h-4z"/>`),
  ...
  "bookmark": defineIcon("Interface", "Bookmark", "Save the current project for later", `<path d="M6.5 3.5h11v17L12 17l-5.5 3.5v-17Z"/>`),
  "folder": defineIcon("Interface", "Folder", "Open saved projects", `<path d="M3.5 6.5h6l2-2h3.5l2 2h3.5v13h-17v-13ZM3.5 9h17"/>`),
  "edit": defineIcon("Interface", "Edit", "Edit the current project", `<path d="m4 20 4.2-1 10.9-10.9a2.2 2.2 0 0 0-3.2-3.2L5 15.8 4 20ZM14.8 6l3.2 3.2M4 20l3.3-3.3"/>`),
